...
export default class PostPropertyLatest extends Component {
  constructor(props) {
    super(props);
    this.state = {
      sharingType: "",
  ...
  handleChange = e => {
    ...
    if (e.target.files[0]) {
      ...
      this.setState({ image: image }, () => {
        console.log("image value after handleChange", this.state.image);
      });
    }
  };
  uploadThruExt = image => {
  ...
  handleUpload = () => {
    ...
    //         console.log("url: "+url)
    //         this.state.imageUrl.push(url);
    //         console.log("this.state.imageUrl.length: "+this.state.imageUrl.length)
    //         for(var i=0; i < this.state.imageUrl.length; i++){
    //             console.log("imageURL: "+this.state.imageUrl[i]);
    //             //this.setState({urls : this.state.urls + this.state.imageUrl[i]})
    //         }
