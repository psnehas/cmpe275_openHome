...
class EditProperty extends Component {
  constructor(props) {
    super(props);
    const { propertyID, property } = this.props.location.state;
    ...
    this.state = {
      ...
      available: false,
      alwaysAvailable: property.availability.alwaysAvailable,
      ...
      imageUrl: [],
      urls: "",
      mon: property.availability.mon,
      tue: property.availability.tue,
      wed: property.availability.wed,
      thu: property.availability.thu,
      fri: property.availability.fri,
      sat: property.availability.sat,
      sun: property.availability.sun,
      editedFlag: false
    };
