                    ...
                    <div>
                      <table style={{width:400}}>
                        ...
                        <tr align="center">
                          ...
                          <td>                            
                            { this.state.property.parking.paid ? this.state.property.parking.dailyFee : "-"}
                          </td>
                        </tr>
                      </table>
                      <hr />
                    ...
                    <div>
                      ...
                      <label class="radio-inline" style={{ paddingRight: 35 }}>
                        <input
                          ...
                          name="rb"
                          onClick={e => {
                            this.setState({ parking: true,  isEstimated:false});
                          }}
                          value="true"
                        />
                        Yes
                      ...
                      <label class="radio-inline">
                        <input
                          ...
                          name="rb"
                          onClick={e => {
                            this.setState({ parking: false,  isEstimated:false});
                          }}
                          value="false"
                        />
                        No
